package com.clone.buckethouse.config;

import com.clone.buckethouse.security.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors() //WebMvcConfig 에서 이미 설정했으므로 기본 cors설정
                ...
                .anyRequest()       //    /와  /auth/** 이외의 경로는 모두 인증해야한다.       ex( /store는 인증해야됨 책의 결과와 같음.
                .authenticated();
